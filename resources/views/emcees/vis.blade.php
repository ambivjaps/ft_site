...
@section('title')
<title> Emcees: Visayas | FlipTop Battle League </title>
@endsection

@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/emcees/visayas" />
<meta property="og:title"              content="Emcees: Visayas | FlipTop Battle League" />
	...
	<div class="container-xxl">
		...
		<nav class="category-nav">
      		<ul class="nav nav-pills nav-fill">
        		...
        		<li class="nav-item"> <a class="nav-link active" aria-current="page" href="/emcees/visayas"> Visayas </a> </li>
