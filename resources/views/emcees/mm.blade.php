...
@section('title')
<title> Emcees: Metro Manila | FlipTop Battle League </title>
@endsection
	...
	<div class="container-xxl">
		...
		<nav class="category-nav">
      		<ul class="nav nav-pills nav-fill">
        		...
        		<li class="nav-item"> <a class="nav-link active" aria-current="page" href="/emcees/metro-manila"> Metro Manila </a> </li>
		...
		<div class="row mt-3 mb-5">
      		@foreach($emcees as $emcee)
	      		@if($emcee->division == "Metro Manila")
