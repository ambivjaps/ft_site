...
@section('title')
<title> Emcees: Calabarzon | FlipTop Battle League </title>
@endsection

@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/emcees/calabarzon" />
<meta property="og:title"              content="Emcees: Calabarzon | FlipTop Battle League" />
	...
	<div class="container-xxl">
		...
		<nav class="category-nav">
      		<ul class="nav nav-pills nav-fill">
        		...
        		<li class="nav-item"> <a class="nav-link active" aria-current="page" href="/emcees/calabarzon"> Calabarzon </a> </li>
