...
@section('title')
<title> Articles: Crew's In | FlipTop Battle League </title>
@endsection

@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/articles/category/crews-in" />
<meta property="og:title"              content="Articles: Crew's In | FlipTop Battle League" />
  ...
  <div class="container">
    ...
    <nav class="category-nav">
      <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item"> <a class="nav-link active" aria-current="page" href="/articles/category/crews-in"> Crew's In </a> </li>
