...
@section('title')
<title> Articles: Music Reviews | FlipTop Battle League </title>
@endsection

@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/articles/category/music-reviews" />
  ...
  <div class="container">
    ...
    <nav class="category-nav">
      <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item"> <a class="nav-link active" aria-current="page" href="/articles/category/music-reviews"> Music Reviews </a> </li>
