...
@section('title')
<title> Articles: MC Spotlight | FlipTop Battle League </title>
@endsection

@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/articles/category/mc-spotlight" />
<meta property="og:title"              content="Articles: MC Spotlight | FlipTop Battle League" />
  ...
  <div class="container">
    ...
    <nav class="category-nav">
      <ul class="nav nav-pills nav-fill">
        ...
        <li class="nav-item"> <a class="nav-link active" aria-current="page" href="/articles/category/mc-spotlight"> MC Spotlight </a> </li>
