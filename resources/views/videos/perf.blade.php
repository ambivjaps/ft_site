...
@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/videos/perf" />
<meta property="og:title"              content="Videos: Live Performances" />
		...
		@foreach($perfs as $perf)
			<div class="col-md-3 col-6 my-3">
				<a href="/videos/perf/{{ $perf->slug }}">
					<img class="ft-event-logo rounded" src="{{ Voyager::image( $perf->logo ) }}" title="{{ $perf->title }}" style="width:100%">
