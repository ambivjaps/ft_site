...
@section('title')
<title> Emcees | FlipTop Battle League </title>
@endsection

@section('meta')
<meta property="og:url"                content="https://www.fliptop.com.ph/emcees" />
<meta property="og:title"              content="Emcees | FlipTop Battle League" />
	...
	<div class="container">
		...
		<nav class="category-nav">
      		<ul class="nav nav-pills nav-fill">
        		<li class="nav-item"> <a class="nav-link active" aria-current="page" href="/emcees"> All </a> </li>
